...
internal static class LoggerExtensions {
    ...
    internal static void ValidateRequestFailure<TRequest, TResponse>(this ILogger<ValidatePipelineBehavior<TRequest, TResponse>> logger, ValidationResult result)
        where TRequest : IRequestBase {
