...
namespace Nameless.CQRS {
    ...
    public sealed class CQRSServiceRegistration : ServiceRegistrationBase {
        ...
        /// </summary>
        public CQRSServiceRegistration () : base (supportAssemblies: null) { }

        /// <summary>
        /// Initializes a new instance of <see cref="CQRSServiceRegistration"/>.
        /// </summary>
        /// <param name="supportAssemblies">The support assemblies.</param>
        public CQRSServiceRegistration (IEnumerable<Assembly> supportAssemblies) : base (supportAssemblies) { }
