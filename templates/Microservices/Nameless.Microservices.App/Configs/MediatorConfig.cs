...
using Nameless.Microservices.App.PipelineBehaviors;

namespace Nameless.Microservices.App.Configs;

public static class MediatorConfig {
    public static WebApplicationBuilder ConfigureMediator(this WebApplicationBuilder self, Assembly[] assemblies) {
