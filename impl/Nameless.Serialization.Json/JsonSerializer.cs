...
namespace Nameless.Serialization.Json {
    public class JsonSerializer : ISerializer {
        ...
        private static JsonSerializationOptions Parse (SerializationOptions opts) {
            if (opts is JsonSerializationOptions options) {
                return new JsonSerializationOptions {
                    Encoding = options.Encoding ?? JsonSerializationOptions.Default.Encoding,
                    Settings = options.Settings ?? JsonSerializationOptions.Default.Settings
                };
            }

            return JsonSerializationOptions.Default;
        }
