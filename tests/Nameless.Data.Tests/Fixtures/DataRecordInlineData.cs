...
public class DataRecordInlineData : TheoryData<string, object> {
    public DataRecordInlineData() {
        Add(nameof(DataRecordExtensions.GetString), p2: "Value");
        Add(nameof(DataRecordExtensions.GetBoolean), p2: true);
        Add(nameof(DataRecordExtensions.GetChar), p2: 'X');
        ...
        Add(nameof(DataRecordExtensions.GetInt32), p2: 256);
        ...
        Add(nameof(DataRecordExtensions.GetSingle), p2: 3.14f);
        Add(nameof(DataRecordExtensions.GetDouble), p2: 9.10d);
        Add(nameof(DataRecordExtensions.GetDecimal), p2: 100m);
        ...
        Add(nameof(DataRecordExtensions.GetTimeSpan), TimeSpan.FromSeconds(seconds: 15));
