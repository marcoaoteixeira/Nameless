...
[UnitTest]
public sealed class ProducesValidationProblemAttributeTests {
    [Fact]
    ...
    public void WhenContentTypeIsSet_ThenContentTypeIsStored() {
        var attr = new ProducesValidationProblemAttribute(contentType: "application/other+json");
    ...
    public void WhenStatusCodeIsSet_ThenStatusCodeIsStored() {
        var attr = new ProducesValidationProblemAttribute(404);
    ...
    public void WhenInspectingAttributeProperties_ThenAllowMultipleIsFalse() {
        var attr = typeof(ProducesValidationProblemAttribute);
