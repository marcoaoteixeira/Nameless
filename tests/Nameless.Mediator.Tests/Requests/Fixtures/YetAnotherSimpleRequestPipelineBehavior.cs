...
public class YetAnotherSimpleRequestPipelineBehavior : IRequestPipelineBehavior<SimpleRequest, Nothing> {
    private readonly ILogger _logger;

    public YetAnotherSimpleRequestPipelineBehavior(ILogger logger) {
        _logger = logger;
    }
