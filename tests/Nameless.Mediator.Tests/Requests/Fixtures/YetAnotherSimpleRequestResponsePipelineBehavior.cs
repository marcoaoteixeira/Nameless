...
public class YetAnotherSimpleRequestResponsePipelineBehavior : IRequestPipelineBehavior<SimpleRequestResponse, string> {
    private readonly ILogger _logger;

    public YetAnotherSimpleRequestResponsePipelineBehavior(ILogger logger) {
        _logger = logger;
    }
