...
public class QueryableExtensionsTests {
    ...
    public void OrderBy_Should_Order_Asc_By_Property_Name() {
        // arrange
        var array = new[] {
            new Student { Name = "John" }, new Student { Name = "Chris" }, new Student { Name = "Aaron" },
            new Student { Name = "Jennifer" }, new Student { Name = "Martin" }
        };

        var expected = new[] {
            new Student { Name = "Aaron" }, new Student { Name = "Chris" }, new Student { Name = "Jennifer" },
            new Student { Name = "John" }, new Student { Name = "Martin" }
        };
    ...
    public void OrderBy_Should_Order_Desc_By_Property_Name() {
        ...
        var expected = new[] {
            new Student { Name = "Martin" }, new Student { Name = "John" }, new Student { Name = "Jennifer" },
            new Student { Name = "Chris" }, new Student { Name = "Aaron" }
        };
