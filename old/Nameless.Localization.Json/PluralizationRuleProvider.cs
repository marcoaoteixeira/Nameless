...
namespace Nameless.Localization.Json {
    public class PluralizationRuleProvider : IPluralizationRuleProvider {
        ...
        private static readonly Dictionary<string, PluralizationRuleDelegate> Rules;
        ...
        private static CultureInfo GetBaseCulture (CultureInfo culture) {
            ...
            while (result.Parent.Name != string.Empty) {
        ...
        public bool TryGet (CultureInfo culture, out PluralizationRuleDelegate rule) {
            ...
            return Rules.TryGetValue (cultureForPlural.Name, out rule);
        }
