...
/// <summary>
/// Defines methods to implement directory operations.
/// </summary>
...
/// <summary>
/// Extension methods for <see cref="IDirectoryService"/>.
/// </summary>
public static class DirectoryServiceExtension {
    ...
    /// Retrieves all files from a directory.
    /// </summary>
    /// <param name="self">The <see cref="IDirectoryService"/> current instance.</param>
    /// <param name="directoryPath">The directory path.</param>
    /// <param name="filter">The filter.</param>
    /// <param name="recursive">Whether it should look into children directories.</param>
    /// <returns>An array of <see cref="IFile"/>.</returns>
    ...
    /// <param name="self">The <see cref="IDirectoryService"/> current instance.</param>
    /// <param name="directoryPath">The directory path.</param>
    /// <param name="recursive">Whether it should delete children directories.</param>
    ...
    /// <param name="filter">The filter.</param>
    /// <param name="recursive">Whether it should look into children directories.</param>
    /// <returns>An array of <see cref="IDirectory"/></returns>
