...
public sealed class ApplicationContext : IApplicationContext {
    ...
    /// </remarks>
    public ApplicationContext(string environment, string appName, bool useCommonAppDataFolder, Version appVersion, ILogger<ApplicationContext> logger) {
    ...
    private static string BuildAppDataFolderPath(string appName, bool useCommonAppDataFolder, ILogger<ApplicationContext> logger) {
        ...
        catch (Exception ex) { logger.ErrorOnAppDataFolderCreation(ex); return string.Empty; }
