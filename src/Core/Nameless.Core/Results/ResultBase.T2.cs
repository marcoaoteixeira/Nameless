...
public abstract class ResultBase<TArg0, TArg1, TArg2> : IResult {
    ...
    protected ResultBase(int index, TArg0? arg0 = default, TArg1? arg1 = default, TArg2? arg2 = default, Error[]? errors = null) {
        Index = index;
