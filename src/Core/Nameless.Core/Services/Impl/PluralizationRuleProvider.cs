...
/// <summary>
/// Singleton Pattern implementation for <see cref="IPluralizationRuleProvider" />.
...
public sealed class PluralizationRuleProvider : IPluralizationRuleProvider {
    ...
    private PluralizationRuleProvider() {
        ...
        AddRule(["ay", "bo", "cgg", "dz", "fa", "id", "ja", "jbo", "ka", "kk", "km", "ko", "ky", "lo", "ms", "my", "sah", "su", "th", "tt", "ug", "vi", "wo", "zh"], _ => 0);
