...
namespace Nameless.FileStorage.System {
    ...
    public sealed class File : IFile {
        ...
        /// <inheritdoc />
        public string Path => CurrentFile.FullName[Root.Length..].TrimStart(Sys_Path.DirectorySeparatorChar);

        /// <inheritdoc />
        public string DirectoryPath => CurrentFile.DirectoryName![Root.Length..].TrimStart(Sys_Path.DirectorySeparatorChar);
        ...
        public async Task<Stream> OpenAsync(CancellationToken cancellationToken = default) {
            ...
            var result = new FileStream(
                ...
                bufferSize: (int)BufferSize.Small,
                useAsync: false
            );
