namespace Nameless.FileStorage {
    ...
    public interface IFile {
        ...
        /// </param>
        /// <param name="cancellationToken">The cancellation token.</param>
        Task CopyAsync(string destPath, bool overwrite = false, CancellationToken cancellationToken = default);
        ...
        /// </param>
        /// <param name="cancellationToken">The cancellation token.</param>
        Task MoveAsync(string destPath, CancellationToken cancellationToken = default);
