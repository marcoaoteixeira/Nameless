namespace Nameless.FileStorage {
    ...
    public interface IFileStorage {
        ...
        /// </returns>
        Task CreateFileAsync(string relativePath, Stream input, bool overwrite = false, CancellationToken cancellationToken = default);
        ...
        /// </returns>
        Task<IFile> GetFileAsync(string relativePath, CancellationToken cancellationToken = default);

        /// <summary>
        /// Retrieves all files that matches the <paramref name="filter"/> or, if
