...
public static class FileExtensions {
    ...
    /// </returns>
    public static Stream Open(this IFile self, FileMode mode = FileMode.OpenOrCreate, FileAccess access = FileAccess.ReadWrite, FileShare share = FileShare.ReadWrite) {
