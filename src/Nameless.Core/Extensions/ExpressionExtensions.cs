...
public static class ExpressionExtensions {
    ...
    ///     See
    ///     <a href="https://github.com/dotnet/aspnetcore/blob/release/8.0/src/Mvc/Mvc.ViewFeatures/src/ExpressionHelper.cs">
    ///         ExpressionHelper
    ///         source code
    ///     </a>
    /// </summary>
            ...
            switch (part.NodeType) {
                ...
                case ExpressionType.MemberAccess:
                    ...
                    if (segmentCount > 0) {
                        ...
                        builder.Insert(index: 0, CoreConstants.Separators.Dot);
                    }
    ...
    extension<T>(Expression<Func<T, bool>> self) {
        ...
        public Expression<Func<T, bool>> And(Expression<Func<T, bool>> expression) {
            var param = Expression.Parameter(typeof(T), CoreConstants.Separators.Underscore);
    ...
    private static bool IsSingleArgumentIndexer(Expression expression) {
        ...
        return runtimeProperties.Any(property =>
