...
public sealed partial class Throws {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public TimeSpan LowerOrEqual(TimeSpan paramValue, TimeSpan compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public TimeSpan GreaterOrEqual(TimeSpan paramValue, TimeSpan compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue < compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public TimeSpan LowerThan(TimeSpan paramValue, TimeSpan compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue >= compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public TimeSpan GreaterThan(TimeSpan paramValue, TimeSpan compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue <= compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public TimeSpan OutOfRange(TimeSpan paramValue, TimeSpan minimumValue, TimeSpan maximumValue, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public TimeSpan Zero(TimeSpan paramValue, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public TimeSpan Negative(TimeSpan paramValue, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue >= TimeSpan.Zero) {
            return paramValue;
        }
