...
public sealed partial class Throws {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public DateTimeOffset LowerOrEqual(DateTimeOffset paramValue, DateTimeOffset compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public DateTimeOffset GreaterOrEqual(DateTimeOffset paramValue, DateTimeOffset compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue < compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public DateTimeOffset LowerThan(DateTimeOffset paramValue, DateTimeOffset compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue >= compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public DateTimeOffset GreaterThan(DateTimeOffset paramValue, DateTimeOffset compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue <= compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public DateTimeOffset OutOfRange(DateTimeOffset paramValue, DateTimeOffset minimumValue, DateTimeOffset maximumValue, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
