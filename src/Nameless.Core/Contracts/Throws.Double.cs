...
public sealed partial class Throws {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public double LowerOrEqual(double paramValue, double compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public double GreaterOrEqual(double paramValue, double compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue < compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public double LowerThan(double paramValue, double compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue >= compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public double GreaterThan(double paramValue, double compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue <= compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public double Negative(double paramValue, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (!double.IsNegative(paramValue)) {
            return paramValue;
        }
