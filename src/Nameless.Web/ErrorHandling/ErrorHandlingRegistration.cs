...
public class ErrorHandlingRegistration : AssemblyScanAware<ErrorHandlingRegistration> {
    ...
    /// </typeparam>
    /// <returns>
    ///     The current <see cref="ErrorHandlingRegistration"/> so other
    ///     actions can be chained.
    /// </returns>
    public ErrorHandlingRegistration RegisterExceptionHandler<TExceptionHandler>()
    ...
    /// </exception>
    public ErrorHandlingRegistration RegisterExceptionHandler(Type type) {
