...
public sealed class EndpointAttribute([StringSyntax("Route")] string? route = null) : Attribute {
    /// <summary>
    ...
    /// <summary>
    ///     Gets the HTTP verb the endpoint provides
    /// </summary>
    public HttpVerbs Verb { get; init; }
