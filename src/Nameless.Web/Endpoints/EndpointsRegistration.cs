...
/// </summary>
public class EndpointsRegistration : AssemblyScanAware<EndpointsRegistration> {
    ...
    public IReadOnlyCollection<Type> Endpoints => _endpoints;
    ...
    public EndpointsRegistration RegisterEndpoint<TEndpoint>()
        where TEndpoint : IEndpoint {
        return RegisterEndpoint(typeof(TEndpoint));
    }

    public EndpointsRegistration RegisterEndpoint(Type type) {
