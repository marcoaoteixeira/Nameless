...
public class AuthRegistration {
    ...
    /// <summary>
    ///     Whether it should use the predefined JWT Bearer configuration.
    /// </summary>
    public bool UseJwtBearerDefaultConfiguration { get; set; }
    ...
    /// </param>
    /// <returns>
    ///     The current <see cref="AuthRegistration"/> instance, so
    ///     other actions can be chained.
    /// </returns>
    public AuthRegistration RegisterJwtBearerConfiguration(Action<JwtBearerOptions> configure, string? scheme = null) {
