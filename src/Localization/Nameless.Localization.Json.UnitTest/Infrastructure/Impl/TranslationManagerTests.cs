...
public class TranslationManagerTests {
    ...
    public void GetTranslation_Should_Return_Translation_For_Given_Culture() {
        ...
        optionsMock.Setup(mock => mock.Value)
                   .Returns(new LocalizationOptions());
        var sut = new TranslationManager(fileProviderMock.Object, optionsMock.Object, NullLogger<TranslationManager>.Instance);
