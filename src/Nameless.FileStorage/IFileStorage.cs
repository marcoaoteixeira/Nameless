...
namespace Nameless.FileStorage {
    /// <summary>
    /// From: https://github.com/OrchardCMS/OrchardCore
    /// Represents a generic abstraction over a virtual file store.
    /// </summary>
    /// <remarks>
    /// The virtual file storage uses forward slash (/) as the path delimiter, and has no concept of
    /// volumes or drives. All paths are specified and returned as relative to the root of the virtual
    /// file storage. Absolute paths using a leading slash or leading period, and parent traversal
    ...
    public interface IFileStorage {
        ...
        /// <summary>
        /// Creates a new file in the file storage from the contents of an input stream.
        /// </summary>
        /// <param name="path">The path of the file to be created.</param>
        /// <param name="input">The stream whose contents to write to the new file.</param>
        ...
        /// </remarks>
        Task CreateFileFromStream (string path, Stream input, bool overwrite = false);
        ...
        /// <returns>A <see cref="IDirectory"/> object representing the directory.</returns>
