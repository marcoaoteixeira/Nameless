...
internal static class LoggerHandlers {
    internal static readonly Action<ILogger,
        string,
        Exception?> TranslationFileNotFound
    ...
    internal static readonly Action<ILogger,
        string,
        Exception?> ReadTranslationFileContentFailure
    ...
    internal static readonly Action<ILogger,
        string,
        Exception?> TranslationFileEmpty
    ...
    internal static readonly Action<ILogger,
        string,
        Exception?> TranslationObjectDeserializationFailure
        = LoggerMessage.Define<string>(logLevel: LogLevel.Error,
                                       eventId: default,
    ...
    internal static readonly Action<ILogger,
        string,
        Exception?> JsonSerializerReturnNullTranslationObject
        = LoggerMessage.Define<string>(logLevel: LogLevel.Warning,
                                       eventId: default,
