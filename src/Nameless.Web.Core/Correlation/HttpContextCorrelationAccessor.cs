...
/// </summary>
public class HttpContextCorrelationAccessor : ICorrelationAccessor {
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly IOptions<CorrelationOptions> _options;

    /// <summary>
    ///     Initializes a new instance of the <see cref="HttpContextCorrelationAccessor"/>.
    /// </summary>
    /// <param name="httpContextAccessor">The <see cref="IHttpContextAccessor"/>.</param>
    /// <param name="options">The correlation options.</param>
    public HttpContextCorrelationAccessor(IHttpContextAccessor httpContextAccessor, IOptions<CorrelationOptions> options) {
