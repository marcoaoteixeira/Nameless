...
public class OpenTelemetryOptions {
    ...
    /// </summary>
    public Action<AspNetCoreTraceInstrumentationOptions> ConfigureAspNetCoreTraceInstrumentation { get; set; } =
        _ => { };

    /// <summary>
    ///     Gets or sets the action to configure HTTP client trace instrumentation options.
    /// </summary>
    public Action<HttpClientTraceInstrumentationOptions> ConfigureHttpClientTraceInstrumentation { get; set; } =
        _ => { };
