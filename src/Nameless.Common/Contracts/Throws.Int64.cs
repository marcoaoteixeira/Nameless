...
public sealed partial class Throws {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public long LowerOrEqual(long paramValue, long compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public long GreaterOrEqual(long paramValue, long compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue < compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public long LowerThan(long paramValue, long compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue >= compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public long GreaterThan(long paramValue, long compare, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue <= compare) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public long OutOfRange(long paramValue, long minimumValue, long maximumValue, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
    ...
    /// </exception>
    [DebuggerStepThrough]
    public long Zero(long paramValue, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (paramValue > 0) {
            return paramValue;
        }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public long Negative(long paramValue, [CallerArgumentExpression(nameof(paramValue))] string? paramName = null, string? message = null, Func<Exception>? exceptionCreator = null) {
        if (!long.IsNegative(paramValue)) {
            return paramValue;
        }
