...
public static partial class CommonLog {
    ...
    /// <summary>
    ///     Logs message stating that the specific JSON deserialization action failed.
    /// </summary>
    /// <param name="logger">
    ///     The logger.
    /// </param>
    ...
    ///     The tag.
    /// </param>
    [LoggerMessage(level: LogLevel.Error, message: "[{Tag}] Unable to deserialize JSON content to '{Type}'.")]
    public static partial void JsonDeserializationFailure(ILogger logger, Type type, Exception? exception = null, string? tag = null);
}