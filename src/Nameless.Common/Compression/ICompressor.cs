...
/// <summary>
///     Defines methods for compressing and decompressing files and
///     directories asynchronously.
/// </summary>
public interface ICompressor {
    /// <summary>
    ///     Asynchronously compresses the specified files into an archive
    ///     according to the provided request parameters.
    /// </summary>
    /// <param name="request">
    ///     An object that specifies the files, and compression options to
    ///     use for creating the archive.
    /// </param>
