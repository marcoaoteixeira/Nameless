...
public class MailkitMailing : IMailing {
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="MailkitMailing"/> class.
    /// </summary>
    ...
    /// </exception>
    public MailkitMailing(ISmtpClientFactory smtpClientFactory, ILogger<MailkitMailing> logger) {
