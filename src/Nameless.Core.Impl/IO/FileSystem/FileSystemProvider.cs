...
public class FileSystemProvider : IFileSystemProvider {
    ...
    ///     the <see cref="FileSystemProvider"/> class.
    /// </summary>
    /// <param name="options">
    ///     The options for configuring the file system.
    /// </param>
    public FileSystemProvider(IOptions<FileSystemProviderOptions> options) {
        _options = options;
    ...
    ///     will be related to the current <see cref="IFileSystemProvider"/>.
    /// </remarks>
