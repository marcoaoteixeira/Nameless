...
using Xunit;
using JsonSerializer = Nameless.Serialization.Json.JsonSerializer;
...
namespace Nameless.EventSourcing.Test.Events {
    public class EventSerializerTest {
        ...
        public void Can_Create_Instance () {
            ...
            // act
            serializer = new EventSerializer (new JsonSerializer ());
        ...
        public void Can_Serialize_Event () {
            // arrange
            var serializer = new EventSerializer (new JsonSerializer ());
