...
public static class ServiceCollectionExtensions {
    private const string CONNECTION_MANAGER_KEY =
        $"{nameof(IConnectionManager)} :: 27ec4ac9-4ac0-4341-afbb-87c0dcbd84eb";

    private const string CHANNEL_CONFIGURATOR_KEY =
        $"{nameof(IChannelConfigurator)} :: b1102d4d-3289-4b66-afc1-329828dc3c92";
